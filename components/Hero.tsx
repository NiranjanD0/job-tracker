...
const Hero = () => {
    return (
        <div className='fixed h-screen w-full mx-auto flex justify-center items-center overflow-hidden dark:bg-black bg-white'>
            <BackgroundLines className="flex items-center justify-center w-full flex-col px-4 mb-20 md:mb-0">
